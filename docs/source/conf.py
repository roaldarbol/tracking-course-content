...
from trackingcourse import __version__
...
# LinkCode
code_url = f"https://github.com/roaldarbol/tracking-course-content/blob/{git_commit}"
...
def linkcode_resolve(domain, info):
    ...
    if file.parts[0] != "trackingcourse":
...
html_context = {
    # Github options
    "display_github": True,
    "github_user": "roaldarbol",
    "github_repo": "tracking-course-content",
    "github_version": "main",
